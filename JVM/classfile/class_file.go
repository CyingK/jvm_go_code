...
// 获取次版本
func (self *ClassFile) GetMinorVersion() U2 {
	return self.minorVersion
}

// 获取主版本
func (self *ClassFile) GetMajorVersion() U2 {
...
// 获取访问标识
func (self *ClassFile) GetAccessFlags() U2 {
...
func (self *ClassFile) resolve(reader *ClassReader) {
	...
	self.interfaces = reader.readMultiU2()
...
func (self *ClassFile) GetSourceFileAttribute() *ATTRIBUTE_SOURCE_FILE {
	for _, attrInfo := range self.atrributes {
		switch attrInfo.(type) {
		case *ATTRIBUTE_SOURCE_FILE:
			return attrInfo.(*ATTRIBUTE_SOURCE_FILE)
		}
	}
	return nil
}